...
| | |
|---|---|
| Data | 2026-09-03T20:08:53.588Z |
| Projeto | `https://lcqhnfdsrioufwvnrqnt.supabase.co` |
| Execução | `mtlyip61` |
| Resultado | **APROVADO** — 205/205 PASS |
...
| 11b. Selo Fundador (concorrência) | nenhum número emitido abaixo de 100 | todos >= 100 | min 555124, max 555128 | **PASS** |
| 11b. Selo Fundador (concorrência) | exclusão lógica não devolve o número ao pool | número permanece | nº 555125 | **PASS** |
...
| 12. Bucket público | URL pública não carrega token nem expiração | sem ?token= e sem expires | /storage/v1/object/public/kennel-media-public/c78c5f2a-4214-42f0-8c64-b0cf4d55b2b7/canis/publico-mtlyip61.png | **PASS** |
...
| 14. Superfície admin_* | admin chama admin_get_profile_email para B | rls-mtlyip61-b@origemx.test | rls-mtlyip61-b@origemx.test | **PASS** |
...
| 17. Corrigir número do selo | admin tenta atribuir a um canil o número que já pertence a outro | erro — número já pertence a outro canil | erro: o número 555127 já pertence a outro canil | **PASS** |
| 17. Corrigir número do selo | número do canil-alvo não mudou depois da tentativa de duplicidade | nº 555126 | nº 555126 | **PASS** |
...
| 17. Corrigir número do selo | audit_log grava as duas correções, de→para corretos | 2 linhas: {de:555128,para:null} e {de:null,para:555128} | 2 linha(s): [{"de":555128,"para":null},{"de":null,"para":555128}] | **PASS** |
| 17. Corrigir número do selo | canil termina com o número original — round-trip fechado | nº 555128 | nº 555128 | **PASS** |
...
| 20. Exames genéticos | listagem anônima sem filtro NÃO traz exame de cão em rascunho | nenhuma linha do cão em rascunho | 20 linha(s) | **PASS** |
...
| 21. Admin cadastra para outro usuário | admin cadastra cão comum no canil de outro usuário | sucesso — id devolvido | id 5fb39c24-8a46-445e-9fa8-4c773c5f615d | **PASS** |
| 21. Admin cadastra para outro usuário | owner_id vem do canil de destino, created_by é o admin | owner=c4109855-b6d7-4426-8557-77362c4ecc79 kennel=639d9663-ddae-40e9-8c4f-90f3b32be2e0 created_by=465c3632-c700-4a91-855a-e7e83e2efcac | owner=c4109855-b6d7-4426-8557-77362c4ecc79 kennel=639d9663-ddae-40e9-8c4f-90f3b32be2e0 created_by=465c3632-c700-4a91-855a-e7e83e2efcac | **PASS** |
...
| 21. Admin cadastra para outro usuário | admin cadastra ninhada no canil de outro usuário | sucesso — id devolvido | id 9aa28a84-2b53-4549-b510-7b3774c5d9ee | **PASS** |
| 21. Admin cadastra para outro usuário | ninhada nasce SEMPRE rascunho — publicar continua sendo do dono | created_by=465c3632-c700-4a91-855a-e7e83e2efcac published_at=nulo | created_by=465c3632-c700-4a91-855a-e7e83e2efcac published_at=nulo | **PASS** |
| 21. Admin cadastra para outro usuário | cadastro da ninhada gera exatamente 1 linha de auditoria | 1 linha | 1 linha(s) | **PASS** |
| 21. Admin cadastra para outro usuário | filhote cadastrado pelo admin herda par e status da ninhada | litter=9aa28a84-2b53-4549-b510-7b3774c5d9ee status=available par=e9336c35-bb16-4264-bda3-af77a31da27f/eefcc517-a15c-464f-ad4a-941e8debbc24 | litter=9aa28a84-2b53-4549-b510-7b3774c5d9ee status=available sire=e9336c35-bb16-4264-bda3-af77a31da27f dam=eefcc517-a15c-464f-ad4a-941e8debbc24 | **PASS** |
...
| 22. Admin cadastra canil, mídia e publica | canil criado pelo admin pertence a E, com autoria do admin e em rascunho | owner=7b2165ac-0e8f-4f76-a342-82c58e70e1a7 created_by=465c3632-c700-4a91-855a-e7e83e2efcac published_at=null | owner=7b2165ac-0e8f-4f76-a342-82c58e70e1a7 created_by=465c3632-c700-4a91-855a-e7e83e2efcac published_at=null | **PASS** |
...
| 22. Admin cadastra canil, mídia e publica | admin publica o canil de E, e a decisão fica na trilha | published_at preenchido | published_at=2026-09-03T20:08:44.103746+00:00 | **PASS** |
| 22. Admin cadastra canil, mídia e publica | publicação por admin gera 1 linha de auditoria identificando o admin | 1 linha, ator=465c3632-c700-4a91-855a-e7e83e2efcac | 1 linha(s), ator=465c3632-c700-4a91-855a-e7e83e2efcac | **PASS** |
| 22. Admin cadastra canil, mídia e publica | mídia com caminho no prefixo do ADMIN, e não do dono | erro — check_violation | erro: o caminho precisa começar pelo id do dono (c4109855-b6d7-4426-8557-77362c4ecc79), e começa por "465c3632-c700-4a91-855a-e7e83e2efcac" | **PASS** |
| 22. Admin cadastra canil, mídia e publica | mídia registrada pelo admin pertence ao DONO, com mime lido do Storage | owner=c4109855-b6d7-4426-8557-77362c4ecc79 created_by=465c3632-c700-4a91-855a-e7e83e2efcac mime=image/png | owner=c4109855-b6d7-4426-8557-77362c4ecc79 created_by=465c3632-c700-4a91-855a-e7e83e2efcac mime=image/png | **PASS** |
...
| 23. Cadastro assistido | escrita sob sessão vira trilha com o motivo da sessão | >=1 linha, ator=465c3632-c700-4a91-855a-e7e83e2efcac | 1 linha(s), ator=465c3632-c700-4a91-855a-e7e83e2efcac, motivo=criador pediu ajud | **PASS** |
| 23. Cadastro assistido | mídia gravada sob sessão nasce com owner_id do CRIADOR | 1 linha, owner=c78c5f2a-4214-42f0-8c64-b0cf4d55b2b7 | owner=c78c5f2a-4214-42f0-8c64-b0cf4d55b2b7 | **PASS** |
...
| 24. GRANT das colunas novas | o DONO grava `breeds` no próprio canil | 1 linha | 1 linha(s) | **PASS** |
| 24. GRANT das colunas novas | publicação automática grava `auto_published_at` no cão | 1 linha | 1 linha(s) | **PASS** |
| 24. GRANT das colunas novas | o dono NÃO alcança `hidden_at`, que é moderação | erro 42501 — barrado pelo GRANT de coluna | erro 42501: permission denied for table dogs | **PASS** |
