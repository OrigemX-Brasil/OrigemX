...
| | |
|---|---|
| Data | 2026-08-06T22:20:12.772Z |
| Projeto | `https://rvdsrpbybsrrqljparnw.supabase.co` |
| Execução | `msi2wpo6` |
...
| 12. Bucket público | URL pública não carrega token nem expiração | sem ?token= e sem expires | /storage/v1/object/public/kennel-media-public/aaf77ba2-55f7-4e1f-90b8-1deff3f26e23/canis/publico-msi2wpo6.png | **PASS** |
