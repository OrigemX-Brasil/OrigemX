...
import { AdminDogForm } from "@/modules/admin/components/admin-dog-form";
...
export const metadata: Metadata = { title: "Cadastrar cão — Admin" };

/**
 * Cadastro de cão EM NOME DO DONO do canil.
 *
 ...
 */
export default async function AdminNovoCaoPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-2">
        ...
        <h1 className="font-display text-2xl font-semibold tracking-tight">Cadastrar cão</h1>
      </div>
